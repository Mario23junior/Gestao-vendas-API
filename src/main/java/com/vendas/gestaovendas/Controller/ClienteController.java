...
public class ClienteController {
	...
	@ApiOperation(value = "Atualizando dados de clientes")
	@PutMapping("/{codigo}")
	public ResponseEntity<ClienteResponseDTO> atualizar(@PathVariable Long codigo, @Valid @RequestBody ClienteRequestDTO clienteDto){
	   ...
	   return ResponseEntity.ok(ClienteResponseDTO.converterPataClienteDTO(clienteAtualizado));		                
	}
	
	@ApiOperation(value = "Deletando dados de cliente")
